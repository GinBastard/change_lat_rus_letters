...
def change_lat_rus_letters(text, mode='lat_to_rus'):
    ...
    :params:: text - значение из столбца, mode - режим перевода 'lat_to_rus', 'rus_to_lat'
    '''
...
def change_letters_in_text(text, letters_dict):
    ...
    :params:: text - значение из столбца, letters_dict - выбранный словарь соответствия символов
    '''
